<?php
/**
 * Title: Video Hero With CTA and Title
 * Slug: master-of-magic-theme/video-hero-with-cta-and-title
 * Categories: heroes
 * Description: Video hero with cta and title pattern for Master of Magic Theme.
 *
