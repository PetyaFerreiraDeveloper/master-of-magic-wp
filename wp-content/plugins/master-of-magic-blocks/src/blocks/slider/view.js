...
const buildMarqueeOptions = (ref, baseOptions) => {
  const wrapper = q(ref, '.wp-block-master-of-magic-blocks-slider-slides');
...
store('master-of-magic-blocks/slider', {
  callbacks: {
    setup() {
      ...
      const baseOptions = {
        wrapperClass: 'wp-block-master-of-magic-blocks-slider-slides',
        slideClass: 'wp-block-master-of-magic-blocks-slider-slide',
