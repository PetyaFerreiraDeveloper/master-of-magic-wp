...
<div
	...
	?>
		data-wp-interactive="master-of-magic-blocks/slider"
...
>
	<div class="swiper-wrapper wp-block-master-of-magic-blocks-slider-slides">
		<?php
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo $content;
		?>
	...
	<ul
		...
		aria-label="<?php esc_attr_e( 'Slider navigation', 'master-of-magic-blocks' ); ?>"
	></ul>
		...
		<div class="swiper-controls">
			...
			<div class="swiper-nav">
				<button
					...
					type="button"
					aria-label="<?php esc_attr_e( 'Previous slide', 'master-of-magic-blocks' ); ?>"
				>
				...
				<button
					...
					type="button"
					aria-label="<?php esc_attr_e( 'Next slide', 'master-of-magic-blocks' ); ?>"
				>
					<svg class="swiper-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
